...
local function worker(format)
    ...
    for line in f:lines() do
		...
		if math.floor(down/1024*10)/10 < 0.1 then
		  args["{"..name.." down_kb}"] = '000.0'
		elseif math.floor(down/1024*10)/10 < 10 then
		  args["{"..name.." down_kb}"] = "00"..math.floor(down/1024*10)/10
		elseif math.floor(down/1024*10)/10 < 100 then
		  args["{"..name.." down_kb}"] = "0"..math.floor(down/1024*10)/10
		elseif math.floor(down/1024*10)/10 < 10000000 then
		  args["{"..name.." down_kb}"] = math.floor(down/1024*10)/10
		else
		  args["{"..name.." down_kb}"] = '000.0'
		end
		
		if math.floor(up/1024*10)/10 < 0.1 then
		  args["{"..name.." up_kb}"] = '000.0'
		elseif math.floor(up/1024*10)/10 < 10 then
		  args["{"..name.." up_kb}"] = "00"..math.floor(up/1024*10)/10
		elseif math.floor(up/1024*10)/10 < 100 then
		  args["{"..name.." up_kb}"] = "0"..math.floor(up/1024*10)/10
		elseif math.floor(up/1024*10)/10 < 10000000 then
