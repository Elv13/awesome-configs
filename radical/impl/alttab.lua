...
local function new(args)
  local currentMenu = menu({filter = true, show_filter=true, autodiscard = true,
    disable_markup=true,fkeys_prefix=true,width=(((capi.screen[capi.client.focus.screen or capi.mouse.screen]).geometry.width)/2)})

  local t = tag.selected(capi.client.focus.screen or capi.mouse.screen)
