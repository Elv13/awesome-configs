...
local function update(pbar)
    ...
    if data[pbar].border_color then
        -- Draw border
        img:draw_rectangle(0, 3, width, height -6, false, data[pbar].border_color)
        over_drawn_width = width - 6 -- remove 2 for borders
        over_drawn_height = height - 10 -- remove 2 for borders
        border_width = 1
    end
    ...
    if data[pbar].gradient_colors then
        img:draw_rectangle_gradient(border_width+1, border_width+4,
                                    over_drawn_width, over_drawn_height,
                                    data[pbar].gradient_colors, angle)
    else
        img:draw_rectangle(border_width+1, border_width+4,
                           over_drawn_width, over_drawn_height,
    ...
    if data[pbar].vertical then
        ...
        img:draw_rectangle(border_width + rel_x +4,
                           border_width +4,
