...
shifty.config.tags ={ 
    ["Term"] =       {  init = true, 
			position = 1, 
			exclusive = true, 
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/term.png",
			max_clients = 5,
			screen = {1, 2},
    ...
    ["Internet"] =   {  init = true, 
			position = 2, 
			exclusive = true, 
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/net.png",
			screen = 1,
			layout = awful.layout.suit.max },
    ["Files"] =      {  init = true, 
			position = 3, 
			exclusive = true, 
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/folder.png",
			max_clients = 5,
			layout = awful.layout.suit.tile },
    ["Develop"] =    {  init = true, 
			position = 4, 
			exclusive = true, 
			screen = {1,2},
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/bug.png",
			layout = awful.layout.suit.max },
    ["Edit"] =       {  init = true, 
			position = 5, 
			exclusive = true, 
			screen = {1,2},
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/editor.png",
			max_clients = 5,
    ...
    ["Doc"] =        {  init = true, 
			position = 7, 
			exclusive = true, 
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/info.png",
			screen = 3,
			layout = awful.layout.suit.max },
    ["Imaging"] =    {  init = false, 
			position = 10, 
			exclusive = true,
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/image.png",
			layout = awful.layout.suit.max },
    ["Picture"] =    {  init = false, 
			position = 10, 
			exclusive = true,
    ...
    ["Video"] =      {  init = false, 
			position = 10, 
			exclusive = true,
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/video.png",
			layout = awful.layout.suit.max },
    ["Movie"] =      {  init = false, 
			position = 12, 
			exclusive = true,
    ...
    ["3D"] =         {  init = false, 
			position = 10, 
			exclusive = true,
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/3d.png",
    ...
    ["Down"] =       {  init = false, 
			position = 10, 
			exclusive = true,
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/download.png",
			layout = awful.layout.suit.max },
    ["Office"] =     {  init = false, 
			position = 10, 
			exclusive = true,
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/office.png",
			layout = awful.layout.suit.max },
    ["RSS"] =        {  init = false, 
			position = 10, 
			exclusive = true,
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/rss.png",
			layout = awful.layout.suit.max },
    ["Chat"] =       {  init = false, 
			position = 10, 
			exclusive = true,
			screen = 2,
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/chat.png",
			layout = awful.layout.suit.tile },
    ["Burning"] =    {  init = false, 
			position = 10, 
			exclusive = true,
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/burn.png",
			layout = awful.layout.suit.tile },
    ["Mail"] =       {  init = false, 
			position = 10, 
			exclusive = true,
			screen = 2,
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/mail2.png",
			layout = awful.layout.suit.max },
    ["IRC"] =        {  init = false, 
			position = 10, 
			exclusive = true,
			...
			init = true,
                        spawn = "konversation",
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/irc.png",
    ...
    ["Game"] =       {  init = false, 
			...
			position = 10, 
			exclusive = false,
			icon = awful.util.getdir("config") .. "/Icon/tags_invert/game.png",
			layout = awful.layout.suit.max,
			},
    ["Gimp"] =       {  init = false, 
			position = 10, 
