...
shifty.config.tags ={ 
    ["Term"] =       {  init        = true, 
			position    = 1, 
			exclusive   = true, 
			icon        = (config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "term.png"),
			max_clients = 5,
			screen      = {1, 2},
    ...
    ["Internet"] =   {  init        = true, 
			position    = 2, 
			exclusive   = true, 
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "net.png",
			screen      = 1,
			layout      = awful.layout.suit.max },
    ["Files"] =      {  init        = true, 
			position    = 3, 
			exclusive   = true, 
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "folder.png",
			max_clients = 5,
			layout      = awful.layout.suit.tile },
    ["Develop"] =    {  init        = true, 
			position    = 4, 
			exclusive   = true, 
			screen      = {1, 2},
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "bug.png",
			layout      = awful.layout.suit.max },
    ["Edit"] =       {  init        = true, 
			position    = 5, 
			exclusive   = true, 
			screen      = {1,2},
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "editor.png",
			max_clients = 5,
			layout      = awful.layout.suit.tile.bottom },
    ["Media"] =      {  init        = true, 
			position    = 6, 
			exclusive   = true, 
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "media.png",
			layout      = awful.layout.suit.max },
    ["Doc"] =        {  init        = true, 
			position    = 7, 
			exclusive   = true, 
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "info.png",
			screen      = 3,
			layout      = awful.layout.suit.max },
    ["Imaging"] =    {  init        = false, 
			position    = 10, 
			exclusive   = true,
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "image.png",
			layout      = awful.layout.suit.max },
    ["Picture"] =    {  init        = false, 
			position    = 10, 
			exclusive   = true,
    ...
    ["Video"] =      {  init        = false, 
			position    = 10, 
			exclusive   = true,
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "video.png",
			layout      = awful.layout.suit.max },
    ["Movie"] =      {  init        = false, 
			position    = 12, 
			exclusive   = true,
    ...
    ["3D"] =         {  init        = false, 
			position    = 10, 
			exclusive   = true,
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "3d.png",
    ...
    ["Down"] =       {  init        = false, 
			position    = 10, 
			exclusive   = true,
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "download.png",
			layout      = awful.layout.suit.max },
    ["Office"] =     {  init        = false, 
			position    = 10, 
			exclusive   = true,
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "office.png",
			layout      = awful.layout.suit.max },
    ["RSS"] =        {  init        = false, 
			position    = 10, 
			exclusive   = true,
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "rss.png",
			layout      = awful.layout.suit.max },
    ["Chat"] =       {  init        = false, 
			position    = 10, 
			exclusive   = true,
			screen      = 2,
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "chat.png",
			layout      = awful.layout.suit.tile },
    ["Burning"] =    {  init        = false, 
			position    = 10, 
			exclusive   = true,
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "burn.png",
			layout      = awful.layout.suit.tile },
    ["Mail"] =       {  init        = false, 
			position    = 10, 
			exclusive   = true,
			screen      = 2,
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "mail2.png",
			layout      = awful.layout.suit.max },
    ["IRC"] =        {  init        = false, 
			position    = 10, 
			exclusive   = true,
			...
			init        = true,
                        spawn       = "konversation",
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "irc.png",
    ...
    ["Game"] =       {  init        = false, 
			...
			position    = 10, 
			exclusive   = false,
			icon        = config.data.iconPath .. (config.data.useListPrefix == true and "tags_invert/" or "tags/") .. "game.png",
			layout      = awful.layout.suit.max,
			},
    ["Gimp"] =       {  init        = false, 
			position    = 10, 
